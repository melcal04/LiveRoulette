...
public class GameTest7 extends Gameplay {
    ...
    public static void verify() {
        ...
        EventHandler.click(DealerTable.BettingOption.getSideBet(bettingOption));
        AssertHandler.assertTrue(ConditionHandler.isDisplayed(DealerTable.BettingChip.getSideBet(bettingOption)),
