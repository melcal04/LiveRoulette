...
public class ResAndStatsTest5_6 extends ResAndStats implements ResAndStatsTestCase {
    ...
    public void checkStatistics() {
        ...
        expectedHighPercentage = Math.round(((float) size / totalResultHistory) * 100.0 * 100.0) / 100.0;
    ...
    public void saveTestCase(String[] roundResult, List<ResAndStatsTestCase> resAndStatsTestCaseList) {
        if (TestConditions.isHighWin(roundResult)) {
            ...
            resAndStatsTestCaseList.removeIf(resAndStats -> resAndStats instanceof ResAndStatsTest5_6 && resAndStats.getTestCase() == testCase
