...
public class ResAndStatsTest2 extends ResAndStats implements ResAndStatsTestCase {

    private static final int testCase = 2, division = 0;
    ...
    public void saveTestCase(String[] roundResult, List<ResAndStatsTestCase> resAndStatsTestCaseList) {
        if (TestConditions.isRedWin(roundResult)) {
            ...
            resAndStatsTestCaseList.removeIf(resAndStats -> resAndStats instanceof ResAndStatsTest2 && resAndStats.getTestCase() == testCase
