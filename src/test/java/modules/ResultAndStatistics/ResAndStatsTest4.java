...
public class ResAndStatsTest4 extends ResAndStats implements ResAndStatsTestCase {

    private static final int testCase = 4, division = 0;
    ...
    public void saveTestCase(String[] roundResult, List<ResAndStatsTestCase> resAndStatsTestCaseList) {
        if (TestConditions.isZeroWin(roundResult)) {
            ...
            resAndStatsTestCaseList.removeIf(resAndStats -> resAndStats instanceof ResAndStatsTest4 && resAndStats.getTestCase() == testCase
