...
public class FuncTest32 extends Functionality {
    ...
    public static void checkTheBettingChip() {
        WaitHandler.wait(2);
        oldChip = GetHandler.getAttribute(DealerTable.Container.RedBettingChip, "class");
    }
    ...
    public static void verify() {
        ...
        double bet = getChipValue(DealerTable.BettingChip.getSideBet(BettingOption.RED));
        ...
        String chip = GetHandler.getAttribute(DealerTable.Container.RedBettingChip, "class");
