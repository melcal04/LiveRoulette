...
public class BetInfoTest1 extends BetInformation {
    ...
    public static void verify() {
        ...
        verifyDisplay(BetDetails.BettingChip.getSideBet(betOption));
        ...
        AssertHandler.assertTrue(isWins(winBettingOptions, betOption),
                "** " + BetDetails.BettingOption.getSideBet(betOption).getName() + " Wins",
                "** " + BetDetails.BettingOption.getSideBet(betOption).getName() + " Loses");
