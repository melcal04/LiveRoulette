...
public class BettingOption {
    ...
    public static final String LOW = "1to18";
    public static final String HIGH = "19to36";
    public static final String FIRST_DOZEN = "1st12";
    public static final String SECOND_DOZEN = "2nd12";
    public static final String THIRD_DOZEN = "3rd12";
    public static final int FIRST_COLUMN = 1;
    public static final int SECOND_COLUMN = 2;
    public static final int THIRD_COLUMN = 3;
    public static final String[] SIDE_BET_LIST = { RED, BLACK, EVEN, ODD, LOW, HIGH, FIRST_DOZEN, SECOND_DOZEN, THIRD_DOZEN };
